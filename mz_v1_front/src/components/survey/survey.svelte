<script>
  import Radio from "../../routes/result/radio.svelte";
...
<div>
  <div class= survey-container >
      <div class="question">1. SNS나 인터넷, 유튜브를 하루 평균 몇 시간 사용하시나요?</div>
      <Radio options={SNS_time} fontSize={font} legend=''  bind:userSelected={SNS}/>
  </div>
  <div class= survey-container>
      ...
      <Radio options={well_serviced} fontSize={font} legend=''  bind:userSelected={v2f} />
      <br>
      {#if v2f in [0, 1]}
...
{/if}
  ...
  <div class= survey-container>
      ...
      <Radio options={face_to_gif_well} fontSize={font} legend=''  bind:userSelected={f2g}/>
      <br>
      <p class="question"> 6. 더 다양한 영상이 추가되길 원하시나요?</p>
      <Radio options={more_based_gif} fontSize={font} legend=''  bind:userSelected={mbg} />
      <br>
      {#if mbg}
  ...
  <div class= survey-container>
      ...
      <Radio options={waiting_or_not} fontSize={font} legend=''  bind:userSelected={won}/> <br>
      {#if won}
...
{/if}
  ...
  <div class= survey-container>
      ...
      <Radio options={dissatified_service} fontSize={font}  legend='' bind:userSelected={service}/><br>
  ...
  <div
    ...
    style="
      ...
      font-size: var(--body-small-font-size, 30px);
      line-height: var(--body-small-line-height, 30px);
